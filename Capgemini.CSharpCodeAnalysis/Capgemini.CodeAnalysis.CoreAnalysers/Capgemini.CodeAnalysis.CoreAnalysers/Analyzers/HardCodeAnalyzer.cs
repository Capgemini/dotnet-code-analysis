...
{
    /// <summary>
    /// Hard-coded values must be avoided at all costs.This applies to string literals as well as numeric identifiers, and must be declared as constants, variables or fields as appropriate.
    /// Enums for OptionSetValues and constants for entity and attribute logical names generated by the Early-Bound entity model generator must be used instead.
    /// </summary>
    ...
    public class HardCodeAnalyzer : AnalyzerBase
    {
        private static readonly DiagnosticDescriptor Rule =
                                                            new DiagnosticDescriptor(
                                                                AnalyzerType.HardCodeAnalyzerId.ToDiagnosticId(),
                                                                nameof(HardCodeAnalyzer),
                                                                $"{nameof(HardCodeAnalyzer)}: {{0}}",
